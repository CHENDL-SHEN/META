...
def resnest50(pretrained=False, root='~/.encoding/models', **kwargs):
    ...
    #         model_dir='/media/ders/sdd1/XS/pipeline/weights/PreWeights/',
    #         progress=True, check_hash=True))

    if pretrained:
        model.load_state_dict(torch.load("/media/ders/sdd1/XS/pipeline/weights/PreWeights/resnest50-528c19ca.pth"))
