...
from tools.ai.torch_utils import set_seed, calculate_parameters, save_model, str2bool
...
def get_params():
    ...
    parser.add_argument('--afflossPara', default=0.0, type=float)
    ...
    parser.add_argument(
        '--expName',
        default='CAM_SOTA/CAM_CLS/META/CAM_train_PriMETA',
        type=str,
    )
    parser.add_argument('--compName', default='CAM_CLS', type=str)
...
def main(args):
    ...
    evaluator = meta_s1_infer_cam.evaluator(
        args.dataset,
        domain=args.domain,
        SSTB=args.SSTB,
        refine_list=[0],
